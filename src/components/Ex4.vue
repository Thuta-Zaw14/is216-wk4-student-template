...
<template>
    ...
    <div id="part1">
        ...
        <button type="button" 
        :class="{'btn':true,'btn-primary':blueBtn,'btn-danger':!blueBtn}"
    ...
    <div id="part2">
        ...
        <button type="button" 
        :class="{'btn':true,'btn-primary':!redBtn,'btn-danger':redBtn}"
        v-on:click="changeTextColor">Change Color</button>
    </div>
